...
<table id="yii-debug-toolbar-mongo-callstack" class="tabscontent">
    <thead>
        <tr>
            <th>#</th>
...
<?php else : ?>
<p id="yii-debug-toolbar-mongo-callstack" class="tabscontent">
    <?php echo Yii::t('yii-debug-toolbar','No mongo queries were recorded during this request or profiling the mongo is DISABLED.')?>
</p>
<?php endif; ?>